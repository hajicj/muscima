...
from muscima.io import parse_cropobject_class_list, parse_cropobject_list, export_cropobject_list
from muscima.stafflines import merge_staffline_segments, build_staff_cropobjects, build_staffspace_cropobjects, add_staff_relationships
...
class DependencyGrammar(object):
    ...
    * One stem can be attached to multiple noteheads, but at least one.
    ...
    >>> fpath = os.path.dirname(os.path.dirname(__file__)) + u'/test/test_data/mff-muscima-mlclasses-annot.deprules'
    >>> mlpath = os.path.dirname(os.path.dirname(__file__)) + u'/test/test_data/mff-muscima-mlclasses-annot.xml'
